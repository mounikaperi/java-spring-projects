...
public class PathsInJava7 {
    ...
    private static void buildPath() throws IOException {
      ...
      System.out.println("The file name is: " + fileName.toString());
      System.out.println("The File system is: " + path.getFileSystem().toString());
      System.out.println("The File system separator is: " + path.getFileSystem().getSeparator());
